  ...
  return (
    ...
    <Card>
      ...
      <CardContent className="grid gap-1">
        ...
        <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all hover:bg-accent hover:text-accent-foreground">
             <Avatar className="hidden h-9 w-9 sm:flex">
                <AvatarImage src="https://lh3.googleusercontent.com/a/ACg8ocIO2R4N1_BNIQLvRjWa7HQmDixI6JoT_afb0CeGYu0nEuuzeeY=s96-c" alt="Avatar" />
                <AvatarFallback>KS</AvatarFallback>
              </Avatar>
          <div className="space-y-1">
            ...
            <img src="https://storage.googleapis.com/discordbot-5a1b5.appspot.com/753acf2f-518f-4771-83d9-d823d97ea7ce.jpg" alt="Image" width={300} height={550} className="mt-4 mb-2 rounded-lg" />
